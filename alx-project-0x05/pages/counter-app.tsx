...
const CounterApp: React.FC = () => {
    ...
    const decremet = () => { setCount(count > 0 ? count - 1 : 0) };

    return (
        <div className="min-h-screen bg-gradient-to-r from-yellow-400 to-prink-500 flex flex-col justify-center items-center text-white">
            {/* Title */}
